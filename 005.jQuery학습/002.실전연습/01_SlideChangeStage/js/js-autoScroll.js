...
// ㅇ_<  {_____________________________________________)
...
/***********************************************************************
    ...
    -> 휠 이벤트명: wheel
    (예전엔 mousewheel 이벤트가 사용됨 - 현재는 공식적으로 폐기됨)
    ...
    4. scroll 이벤트와 wheel 이벤트 비교(둘은 다르다!)
        (1) 공통점: 스크롤되는 페이지의 이치이동
        (2) 차이점: 마우스 휠의 동작에만 반응하는 이벤트 <- wheel
                    스크롤바의 이동에 반응하는 이벤트 <- scroll
    ...
    (3) passive: 스크롤 성능 향상을 위한 옵션으로 true일 경우, 
                ...
                -> 최근 업데이트 된 브라우저는 passive 기본값이 true로
                셋팅됨으로 window, document, body 이 세가지 객체에 대해
                스크롤 막기 기능을 비활성화 하였다!!
                따라서 기본기능을 막고자 하면 passive:false로 기능을
                활성화 해야 한다
***********************************************************************/

...
/*****************************************************
        ...
        작동하도록 최상위 배열요소를 함수로 전달하여
        내부 기능셋팅시 document로 선택했던 요소를
        모두 개별 최상위 배너 요소 하위 요소 선택으로
        변경하면 기존 변수셋팅을 그대로 사용하여 개별 배너
        모듈화를 손쉽게 할 수 있다!
...
// 배너셋팅함수 //////////////
function setBan(obj,seq){ // obj = 최상위요소 객체 / seq - 요소 순번
    // 1. 호출확인
    // console.log("배너야~!");
    ...
    // [슬라이드 기본기능 구현] _________________________________///////////////////

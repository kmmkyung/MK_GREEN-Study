...
/*
    [ 구현 요구사항 ]
    -도시별 메뉴버튼을 클릭시 해당도시의 데이터를 큐브회전후 도시와 매칭하여
    정보를 화면에 출력한다
*/
    ...
    // 2. 메뉴에 클릭이벤트 설정하기
        ...
        for(let x of menu){ // x는 각각의 a요소
            ...
            x.onclick = ()=>{
                ...
                // 0. 도시정보박스 숨기기(트렌지션 없애기)
                    cbx.style.opacity = "0";
                    cbx.style.transition = "none"
                // 도시정보 스크롤생길 경우 내려놓고 다른 도시가면 스크롤위치가 내려가 있기 때문에 스크롤 위치 맨위로 셋팅하기
                cinfo.scrollTo(0,0);
                ...
                // 변경대상2: .cinfo - 도시명 -> city[mtxt]에 있음
                // innerText로 할당!
                ...
                // 5. 도시 정보 박스 보이기
                // 대상: .cbx 
                // 내용: 큐브 1.5초간 회전 후 도시정보박스가 보여야한다!

...
// createElement(요소명,{JS 코드 작성},요소내용)
...
/****************************************************
    [ JSX는 속성 클래스는 className 으로 표기한다! ]
    <태그 class="클래스명">
    class는 JS에서 키워드 이므로 사용못함! 대신...
    <태그 className="클래스명">
****************************************************/
...
/****************************************************
    [ JSX에서 조건문 사용하기 - if문 ]
    리액트는 if 명령문 지원하지만 JSX내부에서는 지원하지 않는다!!!

    JSX에서 조건문을 사용하려면?
    JSX 외부에서 if문을 사용하거나 아니면 내부에서 삼항연산자를 사용할 수 있다!
****************************************************/
// JSX 외부에서 if문 사용하기
const x = 1000;
...
// 시간이 9보다 크면 지금 집에 들어와 작으면 더 놀다와!

...
function Developer(props){ // 호출시 전달되는 속성
    ...
    // else문 없이도 if문에 들어가면 return 때문에 컴포넌트를 나감!
        return <React.Fragment>
                    <LostDev />
                    <MakeImg isrc={props.isrc} ialt={props.ialt}/>
                </React.Fragment>
...
// 이미지 경로 배열
const wisrc = [
    "http://cdnimage.ebn.co.kr/news/201904/news_1555051693_980678_main1.png",
    "http://img.hani.co.kr/imgdb/resize/2017/1021/150848608292_20171021.JPG",
]

// 컴포넌트 호출하기 1
ReactDOM.render(<Developer isDev={true} isrc={wisrc[0]} ialt="성우의 근본없는 카카오"/>,

...
window.addEventListener("DOMContentLoaded",()=>{
    ...
    for(let x of link){ //x는 각 a요소
        ...
        x.onclick = () => {
            ...
            //=> 데이터가 null인 경우는 if문에서 / undefined인 경우는 if 문에서
            // false와 같이 취급된다!
            // 만약 요소가 없으면 null이 리턴된다!
            // undefined는 변수의 값이나 함수가 생성되지 않은 경우 리턴되는 기본 할당값이다! 

            // console.log(atxt,x.querySelector("img"));
            ...
            // false는 빛이 없음, 즉 신호 없음 => 브라우저는 기본 기능을 없애준다!

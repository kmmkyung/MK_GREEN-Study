...
// 뷰엑스 스토어 JS 가져오기
// 중요! 반드시 메인JS파일 한곳에서 불러와 써야 상태관리됨!
...
new Vue({
    el: "#cont",
    store, // 뷰엑스 스토어 불러오고(import) 여기에 등록 필수!!!!
}); ////////// 서브영역 Vue component //////////
...
new Vue({
    ...
    mounted: function () {
        ...
        // a요소의 #아이디명으로 기본 위치이동은 되지만 스크롤 애니메이션은
        // 되지 않는다!
        // 이것을 제이쿼리로 구현하자!!!
    ...
    ********************************************/
    ...
    flist.find("li").hover(
        function () {
            ...
            // 중간 객체속성명 상위부모박스 #c1의 data-cat 속성값 읽어와서
            // sinsang[요기][] -> 요기에 넣기

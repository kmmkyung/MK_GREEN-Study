...
/********************************************* 
   ...
   .blur(function(){
    ...
    // 해석: 공백문자 모두(g:global-전역) 찾아서 없애시오(빈공백으로 변경!)
    ...
    // 삼항연산자 (cid가 mnm이나? 응:아니)
    // cv는 current value 즉, 현재값의 뜻
    // val() 메서드 - input 요소의 값(value)를 읽기/쓰기용
    // trim() 메서드 - 앞뒤공백만 제거(공백만 있으면 공백제거) = 중간공백은 제거 못함
    // groSpace()는 전체공백제거함수(0번으로 내가만든것!)
